        ...
        try {
            ...
            if( $this->vip != null ){
                ...
                if(!$this->exists()){
                    ...
                    $result = LBAPICLI::execute("add-vip", $this);
                    ...
                    if($this->exists()){
                        ...
                        if($result == 304){
                            ...
                            if($overwrite) {
                                return LBAPICLI::execute("edit-vip", $this);
                            } else {
                                return $result;
                            }
        ...
        try {
            if( $this->vip != null ){
                ...
                if($this->exists()){
                    ...
                    $result = LBAPICLI::execute("edit-vip", $this);
                    return $result;
        ...
        try {
            if( $this->vip != null ){
                ...
                if($this->exists()){
                    ...
                    $result = LBAPICLI::execute("delete-vip", $this);
...
class L4LBAPIVIP extends LBAPIVIP {
...
class L7LBAPIVIP extends LBAPIVIP {
