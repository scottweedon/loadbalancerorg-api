...
class LBAPIWAF {
    ...
    public function add() {
        ...
        try {
            if( $this->vip != null && $this->waf != null ){
                ...
                $result = LBAPICLI::execute("add-waf", $this);
                switch($result){
                    case 0: return false; break;
                    case 1: return true; break;
                    case 2: return LBAPICLI::execute("edit-waf", $this); break;
                }
    ...
    public function edit() {
        ...
        if( $this->waf != null ){
            ...
            $result = LBAPICLI::execute("edit-waf", $this);
            switch($result){
                case 0: return false; break;
                case 1: return true; break;
    ...
    public function delete() {
        ...
        if( $this->vip != null && $this->waf != null ){
            ...
            $result = LBAPICLI::execute("delete-waf", $this);
            switch($result){
                case 0: return false; break;
                case 1: return true; break;
                case 2: return false; break;
